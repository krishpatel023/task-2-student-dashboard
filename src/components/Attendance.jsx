...
export default function Attendance() {
  ...
  return (
    <div className="w-full h-full bg-primary-color text-primary-complementary rounded-lg flex justify-center items-center">
        <div className="w-[90%] h-[90%] flex flex-col justify-evenly items-center
            ...
            <button className="w-52 h-10 rounded-lg bg-accent-color text-accent-complementary">
                DOWNLOAD
            </button>
        </div>
    </div>
